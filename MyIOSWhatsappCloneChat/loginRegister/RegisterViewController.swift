...
class RegisterViewController: UIViewController {
    ...
    @IBAction func registerBtn(_ sender: UIButton) {
        ...
        if(emailEqual == true && passwordEqual == true){
            ...
            fAuth.createUser(withEmail: email , password: password) { (authDataResult, error) in
                ...
                fAuth.signIn(withEmail: email, password: password, completion: { (authDataResult, error) in
                    ...
                    if let toMainViewControllerVC = self.storyboard?.instantiateViewController(withIdentifier: "navigationController"){
    ...
    @IBAction func backToLoginBtn(_ sender: UIButton) {
        ...
        if let toLoginVC = storyboard?.instantiateViewController(withIdentifier: "authViewController"){
